...
class Ui_DialogLogin(object):
    def setupUi(self, DialogLogin):
        ...
        self.le_redirect_url.setObjectName(u"le_redirect_url")
    ...
    def retranslateUi(self, DialogLogin):
        ...
        self.l_header.setText(QCoreApplication.translate("DialogLogin", u"TIDAL Login", None))
        self.l_description.setText(QCoreApplication.translate("DialogLogin", u"Click the link below and login with your TIDAL credentials. You will be redirected to a page, paste that URL here.", None))
        self.tb_url_login.setPlaceholderText(QCoreApplication.translate("DialogLogin", u"Copy this login URL...", None))
        self.le_redirect_url.setPlaceholderText(QCoreApplication.translate("DialogLogin", u"Paste here!", None))
