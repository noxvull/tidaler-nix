...
from PySide6.QtWidgets import QDialogButtonBox, QLabel, QLineEdit, QSizePolicy, QTextBrowser, QVBoxLayout, QWidget
...
class Ui_DialogLogin:
    def setupUi(self, DialogLogin):
        ...
        self.le_redirect_url = QLineEdit(self.verticalLayoutWidget)
        self.le_redirect_url.setObjectName("le_redirect_url")

        self.lv_main.addWidget(self.le_redirect_url)
    ...
    def retranslateUi(self, DialogLogin):
        ...
        self.l_header.setText(QCoreApplication.translate("DialogLogin", "TIDAL Login", None))
        self.l_description.setText(
            QCoreApplication.translate(
                "DialogLogin",
                "Click the link below and login with your TIDAL credentials. You will be redirected to a page, paste that URL here.",
                None,
            )
        )
        self.tb_url_login.setPlaceholderText(QCoreApplication.translate("DialogLogin", "Copy this login URL...", None))
        self.le_redirect_url.setPlaceholderText(QCoreApplication.translate("DialogLogin", "Paste here!", None))
