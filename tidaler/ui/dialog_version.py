...
class Ui_DialogVersion(object):
    def setupUi(self, DialogVersion):
        ...
        self.l_name_app.setObjectName(u"l_name_app")
        ...
        self.lv_version.setObjectName(u"lv_version")
        self.lh_version = QHBoxLayout()
        self.lh_version.setObjectName(u"lh_version")
        self.l_h_version = QLabel(DialogVersion)
        self.l_h_version.setObjectName(u"l_h_version")
        ...
        self.lv_update.setObjectName(u"lv_update")
        ...
        self.l_error_details.setObjectName(u"l_error_details")
        ...
        self.lh_update_version.setObjectName(u"lh_update_version")
        self.l_h_version_new = QLabel(DialogVersion)
        self.l_h_version_new.setObjectName(u"l_h_version_new")
        ...
        self.l_version_new.setObjectName(u"l_version_new")
        ...
        self.l_changelog_details.setObjectName(u"l_changelog_details")
        ...
        self.lv_download.setObjectName(u"lv_download")
        ...
        self.l_url_github.setObjectName(u"l_url_github")
    ...
    def retranslateUi(self, DialogVersion):
        ...
        self.l_error_details.setText(QCoreApplication.translate("DialogVersion", u"<ERROR>", None))
        self.l_h_version_new.setText(QCoreApplication.translate("DialogVersion", u"New Version Available:", None))
        self.l_version_new.setText(QCoreApplication.translate("DialogVersion", u"v0.0.0", None))
        self.l_changelog.setText(QCoreApplication.translate("DialogVersion", u"Changelog", None))
        self.l_changelog_details.setText(QCoreApplication.translate("DialogVersion", u"<CHANGELOG>", None))
        self.pb_download.setText(QCoreApplication.translate("DialogVersion", u"Download", None))
        self.l_url_github.setText(QCoreApplication.translate("DialogVersion", u"<a href=\"https://github.com/maya-doshi/tidaler/\">https://github.com/maya-doshi/tidaler/</a>", None))
    # retranslateUi
