...
class Ui_DialogSettings:
    def setupUi(self, DialogSettings):
        ...
        self.lh_path_filename_delimiter_artist.setObjectName("lh_path_filename_delimiter_artist")
        ...
        self.lh_path_filename_delimiter_album_artist.setObjectName("lh_path_filename_delimiter_album_artist")
    ...
    def retranslateUi(self, DialogSettings):
        ...
        self.l_icon_filename_delimiter_artist.setText(
            QCoreApplication.translate("DialogSettings", "Artist delimiter", None)
        )
        self.l_filename_delimiter_artist.setText(QCoreApplication.translate("DialogSettings", "Artist delimiter", None))
        self.l_icon_filename_delimiter_album_artist.setText(
            QCoreApplication.translate("DialogSettings", "Album artist delimiter", None)
        )
        self.l_filename_delimiter_album_artist.setText(
            QCoreApplication.translate("DialogSettings", "Album artist delimiter", None)
        )
